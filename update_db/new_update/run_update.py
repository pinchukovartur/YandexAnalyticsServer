...
import time
# my lib
from utils.slack_util import send_message_in_slack, SLACK_GREEN
...
from script_data import request_crashes
...
#add("installations", get_names("installations"))
#
#add("events", get_names("events"))
#add("errors", get_names("errors"))
